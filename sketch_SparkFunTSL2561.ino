//V. Lankar  We changed integration time to 101ms to deal with the light from a light bulb. gain is X1 as we expect a lot of light. 
//original comments:
/* This sensor has an IC and it reads directly lux. But we can still verify the calibration
 *  make sure to power it with 3.3V and not 5V. This is very important. if you plug to 5V, you will kill the sensor ! 
 *   Read the documentation to change the integration time time  and the gain gain  in necessary. 
 *   If there is too much light the sensor can saturate. you get a bad measurement. 
 * 
 * 
 *  the integration time is how long the cell opens. See guide for connections
 *  so for more light (laser)change ms to 101ms - the gain is X1 or X16. X16 is for nigh scences.
 light ranges from 0.1 - 40k+ Lux
This sketch shows how to use the SparkFunTSL2561
library to read the AMS/TAOS TSL2561
light sensor.

Product page: 
Hook-up guide: https://learn.sparkfun.com/tutorials/tsl2561-luminosity-sensor-hookup-guide
https://learn.sparkfun.com/tutorials/tsl2561-luminosity-sensor-hookup-guide
you can also check: https://learn.adafruit.com/tsl2561
...
#include <SparkFunTSL2561.h> // you need to download this library 
...
void print_data(int x, double y)
{
    Serial.print(x, DEC); 
    Serial.print(",");
    Serial.print(y, DEC);    
...
void loop()
{
  ...
  if (light.getData(data0,data1))
  {
    ...
    // un comment below if you need to see the visible light and IR data
    //Serial.print("data0: ");
    //Serial.print(data0);
    //Serial.print(" data1: ");
    //Serial.print(data1);
